    ...
    Box(
        ...
        Card(
            ...
            Column(
                ...
                CustomTextField(value = "", onValueChange = {}, label = "Tên đăng nhập", icon = Icons.Default.Person)
                ...
                Button(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .background( // Áp dụng màu gradient
                            brush = Brush.horizontalGradient(
                                colors = listOf(Color(0xFF9C89FF), Color(0xFFFF89A2)) // Màu bắt đầu -> kết thúc
                            ),
                            shape = RoundedCornerShape(50.dp) // Đảm bảo gradient có bo góc
                        ),
                    colors = ButtonDefaults.buttonColors(containerColor = Color.Transparent), // Đặt màu trong suốt để gradient hoạt động
                ) {
